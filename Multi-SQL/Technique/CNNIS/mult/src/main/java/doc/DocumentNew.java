...
//		}
		DocumentNew d = new DocumentNew();
		List<String> res = d.atomOperationMulti("Select document.id from adb where document.date between 20190607 and 20200607;", d.collectionDefault);
//		for(String i:res) {
